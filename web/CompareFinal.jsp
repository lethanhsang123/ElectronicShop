        ...
        <div class="container ">
            <div class="row"  style="margin-bottom: 50px;">
                <div class="col-md-12 col-sm-12" style="display:inline;">
                    ...
                    <hr class=""/>
                    <table id="" class="compare" style="width:100%;border: 1px;">
                        <thead >
                            <tr>
                                <th></th>
                                <th> ${product1.getProductName()} </th>
                                <th> ${product2.getProductName()} </th>
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <img  src="image/${product1.getImageLink()}" alt="Product picture"/>
                                    <p><strong> ${product1.getSellPrice()}VND</strong></p>
                                    <div class="action">
                                        <div  class="but">
                                            <a href="#">Add to cart</a>
                                        </div>
                                        <div class="but">
                                            <a href="ShopDetailController?do=ViewDetail&categoryID=${product1.getCategoryID()}&productID=${product1.getProductID()}">VIEW</a>
                                        </div>
                                    </div>
                                    </div>
                                </td>
                                <td>
                                    <img  src="image/${product2.getImageLink()}" alt="Product picture"/>
                                    <p><strong> ${product2.getSellPrice()}VND</strong></p>
                                    <div class="action">
                                        <div  class="but">
                                            <a href="#">Add to cart</a>
                                        </div>
                                        <div class="but">
                                            <a href="ShopDetailController?do=ViewDetail&categoryID=${product2.getCategoryID()}&productID=${product2.getProductID()}">VIEW</a>
                                        </div>
                                    </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <th>Height</th>
                                <td>${product1.getHeight()} </td>
                                <td>${product2.getHeight()} </td>
                            </tr>
                            <tr>
                                <th>Width</th>
                                <td>${product1.getWidth()} </td>
                                <td>${product2.getWidth()} </td>
                            </tr>
                            <tr>
                                <th> <i class="fa fa-balance-scale-left"></i>Weight</th>
                                <td>${product1.getWeight()} Kilogram</td>
                                <td>${product2.getWeight()} Kilogram</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
